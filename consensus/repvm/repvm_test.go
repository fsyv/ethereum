...
func TestReimportMirroredState(t *testing.T) {
	...
	var (
		...
		engine = New(params.AllRepvmProtocolChanges.Repvm, db, nil)
	...
	chain, _ := core.NewBlockChain(db, nil, params.AllRepvmProtocolChanges, engine, vm.Config{}, nil, nil)
	defer chain.Stop()

	blocks, _ := core.GenerateChain(params.AllRepvmProtocolChanges, genesis, engine, db, 3, func(i int, block *core.BlockGen) {
