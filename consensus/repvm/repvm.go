...
// Package repvm 信誉值管理(reputation value management)共识的实现
package repvm
...
// Repvm proof-of-authority protocol constants.
var (
...
// Repvm is the proof-of-authority consensus engine proposed to support the
// Ethereum testnet following the Ropsten attacks.
type Repvm struct {
	config *params.RepvmConfig // Consensus engine configuration parameters
